...
</head><title>Manage Borrowed Books</title></head>
<body>

            <div class="wrapper">
                <h2>Borrowed Books</h2>
                <div class="admin-dash">
                    <h1> Edit  and Return Book  </h1><br>
                    ...
                    if (isset($_POST['return_id'])) {
                        ...
                        $query = "SELECT book_id FROM borrow_books WHERE id = $borrow_id";
                ...
                if ($result2 && mysqli_num_rows($result2) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result2)) {
                        ...
                        echo "<td>
                            ...
                            <a href='deleteBook.php?id={$row['book_id']}'>DELETE</a>
                        </td>";
                        echo "</tr>";
                    }
